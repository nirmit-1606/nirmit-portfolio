...
export function CaseStudy() {
  ...
  return (
    <>
      ...
      {/* ── Hero header ── */}
      <section className="px-6 lg:px-8 pt-8 pb-12">
      ...
      <div className="lg:hidden"><Separator /></div>

      {/* ── Next project — mobile only (desktop uses sidebar) ── */}
        ...
        >
          ...
          >
            <div className="min-w-0">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground group-hover:translate-x-1 transition-transform duration-300 truncate">
                {nextCaseStudy.title}
              </h2>
