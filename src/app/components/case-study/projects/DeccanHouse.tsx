...
const SCREENSHOTS = [
  { src: "https://images.unsplash.com/photo-1665470909939-959569b20021?w=1080", alt: "Deccan House screenshot 1" },
  { src: "https://images.unsplash.com/photo-1659673494761-980fdb5fe683?w=1080", alt: "Deccan House screenshot 2" },
  { src: "https://images.unsplash.com/photo-1730993872148-83acdfb597e8?w=1080", alt: "Deccan House screenshot 3" },
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <CaseStudySection>
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}>
            ...
            <p className="text-base sm:text-lg text-foreground leading-relaxed max-w-3xl">
              Placeholder challenge content — replace with the real Deccan House narrative.
            </p>
          </motion.div>
        </CaseStudySection>
        ...
        <CaseStudySection>
          ...
          <MetricsGrid metrics={[
            ...
            { value: "+52%", label: "Day-7 retention" },
            { value: "-73%", label: "Time to first value" },
          ]} />
        </CaseStudySection>
